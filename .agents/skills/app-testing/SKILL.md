...
## Execution
This skill runs using **Codex with subscription plan**. Requires the Playwright MCP server to be configured and available. All browser interactions use Playwright MCP tools (browser_navigate, browser_snapshot, browser_click, browser_type, etc.).
...
- This skill requires Playwright MCP to be configured in Codex
