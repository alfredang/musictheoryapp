...
## Execution
This skill runs using **Codex with subscription plan**. Do NOT use pay-as-you-go API keys. All AI operations should be executed through the Codex CLI environment with an active subscription.
